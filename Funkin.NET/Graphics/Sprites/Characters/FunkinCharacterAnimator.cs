...
namespace Funkin.NET.Graphics.Sprites.Characters
{
    public static class FunkinCharacterAnimator
    {
        ...
        {
            drawable.AddByPrefix(textures, "idle", "Dad idle dance", 24, true);
            drawable.AddByPrefix(textures, "singUP", "Dad Sing Note UP", 24, true);
            drawable.AddByPrefix(textures, "singRIGHT", "Dad Sing Note RIGHT", 24, true);
            drawable.AddByPrefix(textures, "singDOWN", "Dad Sing Note DOWN", 24, true);
            drawable.AddByPrefix(textures, "singLEFT", "Dad Sing Note LEFT", 24, true);
