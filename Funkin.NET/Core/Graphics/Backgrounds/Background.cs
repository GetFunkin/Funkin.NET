...
namespace Funkin.NET.Core.Graphics.Backgrounds
{
    /// <summary>
    ///     See: osu!'s Background. <br />
    ///     A background which offers blurring via a <see cref="osu.Framework.Graphics.Containers.BufferedContainer"/> on demand.
    /// </summary>
